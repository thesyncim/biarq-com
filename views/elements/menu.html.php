<ul class="menu">
    ...
    foreach ($menus as $menu) {
        $add = array();
        if (isset($this->_request->args[0]) && urldecode($this->_request->args[0]) == $menu->titulo
        ) {
...
<ul class="sub-menu">
    ...
    <li>
        <a href="http://www.facebook.com/profile.php?id=100002020123379"><img src="<?= $this->site->baseurl(); ?>/img/pict-1.jpg"
                alt="Página Facebook" /></a></li>

    <li>
        <a href="<?=$this->site->baseurl()?>/projectos/index.rss"><img src="<?= $this->site->baseurl(); ?>/img/pict-3.jpg"
                alt="RSS" /></a></li>
