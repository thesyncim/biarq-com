...
<head>
	...
	<meta name="keywords" content="<?php echo $h($site->Keywords); ?>" />
...
<div class="bg">
	<div class="main">
		...
		<header>
			...
			<div class="row-2">
				<div class="wrapper">
					<h1><a class="logo" href="<?php echo $this->site->baseurl(); ?>">Biarq</a></h1>
				</div>
			</div>
			<div class="box-menu">
						...
						<div class="padding">
							...
							<div class="box3">
								<div class="padding">
									...
									<form id="form-main"
											action="<?php echo $this->site->baseurl(); ?>/pagina/enviarmail"
											method="post">
										<fieldset>
											<label>
		...
		<div class="main">
			<div class="padding">
				<a class="logo2 fright"
						href="<?php echo $this->site->baseurl(); ?>"><img src="<?php echo $this->site->baseurl(); ?>/img/logo2.png"
						alt=""
						width="150" /></a>
